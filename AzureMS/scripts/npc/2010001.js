...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		msg += "#k#d#fs11##L2##i5680222##e#r 성형 샵#k#n #r(Face Shop)#k"+enter;
		msg += "#k#d#fs11##L3##i5680222##e#r 스킨 케어#k#n #r(Skin Color)#k"+enter;
		msg += "#k#d#fs11##L4##i5680222##e#r 컬러 렌즈#k#n #r(Eye Color)#k"+enter;
		msg += "#k#d#fs11##L5##i5680222##e#r 믹스 염색#k#n #r(Mixed Hair Color)#k"+enter;
		msg += "#k#d#fs11##L8##i5680222##e#r 일반 염색#k#n #r(Normal Hair Color)#k"+enter;
			...
			case 4: // lens
				if (cm.getPlayer().getGender() == 0) {
					...
					//cm.getPlayer().getFace() % 100 + 21000 + (cm.getPlayer().getFace() - 21000) - (cm.getPlayer().getFace() % 100);
                		...
                		cm.askAvatar("Please choose your favorite Color.", 렌즈);
			break;
			case 5: // Mix Dyeing
